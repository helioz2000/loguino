...
// - IGate:      5
// - Special:    6
#define S_CALLSIGN      "VK3RHO"
#define S_CALLSIGN_ID   0

// Destination callsign: APRS (with SSID=0) is usually okay.
// Other observed options: APOT30, APNU19, APERXQ, APX204
...
// Symbol to display on APRS web page
#define APRS_SYM_TABLE    '/'
#define APRS_SYMBOL       'r'
...
// TX delay in milliseconds (default 300ms)
#define TX_DELAY      300
